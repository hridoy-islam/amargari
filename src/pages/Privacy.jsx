export const Privacy = () => {
  return (
    <div className="container mx-auto">
      <h1>Privacy Policy for GarirMela.com</h1>
      ...
      <p>
        ...
        information provided to us through the garirmela.com website and related
        services.
      </p>
      ...
      <p>
        ...
        our business, or servicing you, as long as those parties agree to keep
      ...
      <p>
        ...
        contact us using the information below: GarirMela.com Dhaka, Bangladesh
        garirmela@gmail.com
      </p>
      <p>
        This Privacy Policy for GarirMela.com is designed to align with the
        regulations set forth by the Bangladesh Data Protection Act and reflects
        our commitment to safeguarding the privacy of our users.
      </p>
    </div>
  );
};
