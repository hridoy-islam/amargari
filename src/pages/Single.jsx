  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${car?.title} For Sale near ${car?.upazila}, ${car?.district}, ${car?.division}`}
        />
        <meta
          name="keywords"
          content={`${car?.title} garir mela, Dhaka, Car Wash, Car, Car Home Service`}
        />
      ...
      <section className="py-16 px-8">
            ...
            <div className="grid grid-cols-3 md:grid-cols-3 gap-2 ">
              ...
              <Card className="p-4">
                <div className="flex gap-3 ">
                  ...
                  <div>
                    <span className="font-bold text-lg">Transmition</span>{" "}
                    <br />
        ...
        <div className="mx-auto container my-8 shadow-xl p-4 rounded-lg">
          ...
          <p>
            Do not under any circumstances pay in advance. Check the car
            carefully before you buy it. Ask for inspection certificates. Check
            ownership and registration details as well as a vehicle logbook.
            Meet at a safe and public location and bring someone with you. Pay
            after you collect the car. Always request proof of purchase
            (transfer receipt, email..) Look out for significantly undervalued
            cars. If it looks too good to be true, it probably is.
          </p>
        </div>
